...
def build_cpcong_graph(K, J, T):
    """
    Build a constraint graph for the multi-period capacity plannning with congestion effects (cpcong) problem.
    
    Parameters
    ----------
    K : Any
        Number of production units in problem instance.
    J : Any
        Number of products in problem instance.
    T : Any
        Number of time periods in problem instance.
